...
nb_test=1000
nb_intervals=100
plot_title="Xavier init with square root size 8"
init_func=init_matrix.xavier_init
adjust_scale=True
sqroot=True

# dist_plot.plot_eig_magnitudes(nb_test, matrix_dim,init_func,plot_title,nb_intervals)
dist_plot.plot_dist_mul(nb_test, matrix_dim, init_func, plot_title,mulsize,eval_interval,nb_intervals,adjust_scale,sqroot)
